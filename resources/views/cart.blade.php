                    ...
                    @foreach(Cart::content() as $item)
                        ...
                        <td class="product-thumbnail">
                            ...
                            <div class="cart-product__item">
                                <a href="#">
                                    <img src="{{ asset('storage/'.$item->model->image) }}" alt="product" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image">
                                </a>
                        ...
                        <td class="product-quantity">
                            ...
                            <div class="quantity">
                                <a href="{{ route('cart.dec', ['id' => $item->rowId]) }}" class="quantity-minus">-</a>
                                <input title="Qty" class="email input-text qty text" type="text" placeholder="1" readonly value="{{ $item->qty }}">
                                <a href="{{ route('cart.inc', ['id' => $item->rowId]) }}" class="quantity-plus">+</a>
                            </div>
